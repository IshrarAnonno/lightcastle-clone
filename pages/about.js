...
export default function About() {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-brand-blue selection:text-white">
      ...
      {/* Key Metrics Section */}
      <section className="py-16 px-6 md:px-12 border-b border-slate-200/80 bg-slate-100/20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white border border-slate-200/80 p-8 rounded-2xl shadow-sm hover:shadow-md hover:border-brand-blue/35 transition-all">
            <h3 className="text-4xl font-bold text-brand-blue tracking-tight">150+</h3>
            <h4 className="text-xs font-bold text-slate-800 uppercase tracking-wider mt-2">Clients Served</h4>
            <p className="text-[11px] text-slate-600 mt-1">Institutional NGO sponsors, local corporate hubs, and venture capitals.</p>
          </div>
          <div className="bg-white border border-slate-200/80 p-8 rounded-2xl shadow-sm hover:shadow-md hover:border-brand-orange/35 transition-all">
            <h3 className="text-4xl font-bold text-brand-orange tracking-tight">30+</h3>
            <h4 className="text-xs font-bold text-slate-800 uppercase tracking-wider mt-2">Sectors Analyzed</h4>
            <p className="text-[11px] text-slate-600 mt-1">RMG transitions, agricultural logistics, green energy, and micro-finance.</p>
          </div>
          <div className="bg-white border border-slate-200/80 p-8 rounded-2xl shadow-sm hover:shadow-md hover:border-brand-blue/35 transition-all">
            <h3 className="text-4xl font-bold text-brand-blue tracking-tight">USD 150M+</h3>
            <h4 className="text-xs font-bold text-slate-800 uppercase tracking-wider mt-2">Capital Mobilized</h4>
            <p className="text-[11px] text-slate-600 mt-1">Catalytic impact funding, angel cohorts, and seed/series transaction rounds.</p>
          </div>
        </div>
      </section>

      {/* Principles Section */}
      <section className="py-20 px-6 md:px-12 border-b border-slate-200/80 bg-slate-100/10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xs text-slate-500 mt-1">We ground our assessments on transparency, objective frameworks, and localized insights.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 bg-white border border-slate-200/80 rounded-2xl shadow-sm hover:shadow-md transition-all">
              <div className="p-3 bg-brand-blue/10 rounded-full text-brand-blue mb-4">
                <Shield className="h-6 w-6" />
              </div>
              <h3 className="text-sm font-bold uppercase tracking-wider text-slate-800 font-editorial">Institutional Objectivity</h3>
            ...
            <div className="flex flex-col items-center text-center p-6 bg-white border border-slate-200/80 rounded-2xl shadow-sm hover:shadow-md transition-all">
              ...
              <h3 className="text-sm font-bold uppercase tracking-wider text-slate-800 font-editorial">Localized Context</h3>
              <p className="text-xs text-slate-600 mt-2 leading-relaxed">
            ...
            <div className="flex flex-col items-center text-center p-6 bg-white border border-slate-200/80 rounded-2xl shadow-sm hover:shadow-md transition-all">
              ...
              <h3 className="text-sm font-bold uppercase tracking-wider text-slate-800 font-editorial">Systemic Collaboration</h3>
              <p className="text-xs text-slate-600 mt-2 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {CLIENTS.map((client, idx) => (
              <div 
                key={idx}
                className="bg-white border border-slate-200/80 hover:border-brand-blue/30 rounded-xl p-4 flex items-center justify-center h-20 transition-all duration-300 group cursor-default shadow-sm hover:shadow-md"
              >
                <img 
                  src={client.img} 
                  alt={client.name} 
